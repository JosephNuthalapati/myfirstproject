...
public class TicTacToeFrame extends javax.swing.JFrame {
    ...
    private void setScore(){ 
        ...
        jLabel_Score.setText(playerOne+"'s Score is:"+ String.valueOf(playerOneCount) + "\t          " +playersTurn+"'s move"+"\t        "+
                playerTwo + "'s Score is:"+ String.valueOf(playerTwoCount));
    }
    ...
    private void initComponents() {
        ...
        jPanel1_9 = new javax.swing.JPanel();
        ...
        jPanel1_9.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1_9.setLayout(new java.awt.BorderLayout());
        ...
        jPanel1_9.add(jButton9, java.awt.BorderLayout.CENTER);

        jPanel_GridHolder.add(jPanel1_9);
    ...
    private javax.swing.JPanel jPanel1_9;
